...
SpellWaveVLarge::SpellWaveVLarge(int aDamage, int aReloadTime, int aPrice, int aRange, int aDirection, int aMaxDirection, SpellType aType)
    : Spell(aDamage, aReloadTime, aPrice, aRange, aDirection, aMaxDirection, aType)
{
    std::list<QPixmap> *SpriteWaveVLarge = new std::list<QPixmap>;
    SpriteWaveVLarge->push_back(QPixmap(":/spell/images/sort/wave-up-large.png"));
    SpriteWaveVLarge->push_back(QPixmap(":/spell/images/sort/wave-up-large.png"));
    setItsPixMap(SpriteWaveVLarge);
    setIsProjectileSpell(true);
}


void SpellWaveVLarge::updateSpell(std::list<Obstacle *> *someObstacle, std::list<Enemy*>* someEnemy, std::list<Player *> *somePlayer)
{
    Q_UNUSED(somePlayer)
